...
public class BankBookServiceImpl implements BankBookService {
    ...
    public BankBookServiceImpl(BankBookRepository bankBookRepository, CurrencyRepository currencyRepository, BankBookMapper bankBookMapper) {
    ...
    public BankBookDto update(BankBookDto bankBookDto) {
        BankBookEntity bankBookEntity = bankBookRepository.findById(bankBookDto.getId()).orElse(null);
